  ...
  <body>
    <div class="content">
        ...
        <div>
            ...
            <section>
                ...
                <div class="herosection">
                    <h2>SCREENSHOT</h2>
                    <p>Multimedia & Jurnalistik - Hima Ilmu Komputer - Fakultas Matematika dan Ilmu Pengetahuan Alam - Universitas Negeri Semarang</p>
                    <img src="" alt="">
                    <div class="animasitext">
                        <p>Multimedia & Jurnalistik - Hima Ilmu Komputer - Fakultas Matematika dan Ilmu Pengetahuan Alam - Universitas Negeri Semarang</p>
                    </div>
                    <div class="animasitext-2">
                        <p>Multimedia & Jurnalistik - Hima Ilmu Komputer - Fakultas Matematika dan Ilmu Pengetahuan Alam - Universitas Negeri Semarang</p>
                    </div>
                </div>
                <br><br>
                ...
                <div class="tujuan">
                    ...
                    {{-- NOTE: untuk card nanti cukup buat satu lalu dihubungkan dengan database buat memunculkan card baru --}}
                    <div class="card">
                        <img src="" alt="">
                        ...
                        <p>Sebagai media berbagi pengalaman untuk civitas akademika baik mahasiswa,
                            ...
                            menghadapi fenomena.</p>
                    </div>
                    <div class="card">
                        <img src="" alt="">
                        <h5>EXPRESSING IDEAS</h5>
                        <p>Sebagai media penyampai ide dan gagasan yang berkaitan dengan pikiran yang berkembang di masyarakat baik didalam maupun
                            diluar kampus.</p>
                    </div>
                    <div class="card">
                        <img src="" alt="">
                        <h5>EMPOWERING SKILLS</h5>
                        <p>Sebagai media penyalur aspirasi minat dan bakat mahasiswa dalam rangka ikut serta memperluas wawasan dalam bidang keilmuan.</p>
                    </div>
                </div>
                <br><br><br>
                ...
                <div class="divisisection">
                    <div class="listdivisi">
                        <div class="pengurusharian">
                        ...
                        <div class="dna">
                            ...
                            <h5>DESAIN & ANIMASI</h5>
                            <i class="bi bi-arrow-right"></i>
                        </div>
                    </div>
                    {{-- card list  --}}
                    <div class="carddivisi">
                        <img src="" alt="   ">
                        <h5>PENGURUS HARIAN</h5>
                        <p>Bertanggung jawab atas arahan dan pengelolaan keseluruhan organisasi, mengelola dan mendokumentasikan administrasi, serta mengelola keuangan organisasi.</p>
                    </div>
                </div>
            </section>
        </div>
        ...
        <div class="thankyou">
            ...
            <h3>SCREENSHOT</h3>
            <div class="animasitext">
                <p>Screenshot Ilkom - PH | Sinematografi | Jurnalistik | Fotografi | DnA - Semangat Berkarya - Screenshot - PH | Sinematografi | Jurnalistik | Fotografi | DnA - Semangat Berkarya</p>
            </div>
        </div>
        <br><br>
        <footer>
